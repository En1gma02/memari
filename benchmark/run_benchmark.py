"""
run_benchmark.py - RAG Benchmark Orchestrator

Main script that:
1. Loads 100 queries from queries.json
2. Runs hybrid search + re-ranking
3. Generates LLM answers
...
from rag_benchmark import get_benchmark_engine
...
def run_benchmark():
    ...
    for query_data in tqdm(queries, desc="Benchmarking"):
        ...
        # Ground truth: the chunk this query came from
        relevant_ids = {expected_chunk_id}
        
        # Start E2E timer
        e2e_start = time.time()
        
        # Step 1: Hybrid search with re-ranking
